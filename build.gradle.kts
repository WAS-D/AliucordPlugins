...
subprojects {
    ...
    aliucord {
        author("bananercream", 123456789L)
        updateUrl.set("https://raw.githubusercontent.com/WAS-D/AliucordPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/WAS-D/REPONAME/AliucordPlugins/%s.zip")
    }
